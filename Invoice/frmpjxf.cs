...
namespace Invoice
{
    public partial class frmpjxf : Form
    {
        public frmpjxf()
        {
            InitializeComponent();
        ...
        {
            string method = "stock.out.do";
            string placecode = String.Empty;
            if(comboBox1.SelectedIndex>-1)
            {
                ComboboxItem com = comboBox1.SelectedItem as ComboboxItem;

                placecode = com.Value.ToString();
            }
